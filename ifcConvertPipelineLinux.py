...
flag = os.system("./IfcConvert "+ifcFileName+" "+outputFileName+" --use-element-guids --use-world-coords")
...
if(projectFlag == 'Y'):
	...
	projectName = input()
	os.system("/Applications/Unity/Unity.app/Contents/MacOS/Unity -createProject "+projectName)
	print("Completed project creation")
	print("Importing dae files to the project.............")
	os.system("cp "+outputFileName +" "+projectName+"/Assets")
	os.system("cp xmlconvert.xml "+projectName+"/Assets")
